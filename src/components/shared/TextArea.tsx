    ...
    return (
        <div className="relative">
            <div
                ...
                ${errors[id] ? "border-red-500 focus:border-red-500" : "border-zonc-500 focus:border-pink-400"}
                disabled:opacity-70 disabled:cursor-not-allowed`}
            />
            <label htmlFor={id} className={`absolute bg-stone-950 px-1 top-2 left-4 z-[1]
